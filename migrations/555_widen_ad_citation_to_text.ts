...
export default {
  ...
  async down(queryInterface, Sequelize) {
    ...
    if (Number(rows_with_long_values || 0) > 0) {
      throw new Error(
        'Cannot safely revert airworthiness_directives.citation to VARCHAR(255) because rows longer than 255 characters exist.'
      );
    }
